...
namespace CarManagement.Services
{
    public abstract class AbstractVehicleStorage : IVehicleStorage
    {
        ...
        private class PrvVehicleQuery : IVehicleQuery
        {
            ...
            {
                this.vehicles = this.vehicles.Where(vehicle => vehicle.Enrollment.Number == enrollment.Number 
                                                            && vehicle.Enrollment.Serial == enrollment.Serial);
                return this;
            }
